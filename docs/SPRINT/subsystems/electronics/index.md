...
For detailed information about the hardware components, see [Hardware](hardware.md).

## Software

For information about the software systems and control logic, see [Software](software.md).