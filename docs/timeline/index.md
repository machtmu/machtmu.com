...
<div class="gare-timeline-legend" aria-label="Timeline legend">
  ...
  <span class="gare-tag gare-tag--program">Design milestone</span>
  <span class="gare-tag gare-tag--component">Component / pressure test</span>
  <span class="gare-tag gare-tag--coldflow">Cold flow</span>
  <span class="gare-tag gare-tag--hotfire">Ignition / hot fire</span>
  <span class="gare-status gare-status--scrubbed">Scrubbed</span>
  <span class="gare-status gare-status--partial">Partial / failed</span>
  <span class="gare-status gare-status--successful">Successful</span>
</div>
...
<ol class="gare-timeline">
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">New program</span></div>
      <h2>Seraphina name adopted</h2>
      <p>The Seraphina name first appears in the archive on January 27. By January 31 MACH was using it for the 2026 tank-system overhaul: automated fuel and oxidizer loading, firing and pad safing. Opening the supply cylinders and setting the regulators remain manual.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Program transition</span></div>
      <h2>SPRINT is named</h2>
      <p>The SPRINT name first appears on July 24 as “Small-scale Prototyping for Rapid Iteration &amp; Testing.” SPRINT identified the rapid-development test system, not an engine rename.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--right">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Program transition</span><span class="gare-status gare-status--scrubbed">Chimera abandoned</span></div>
      <h2>Chimera ends; SABRE separates</h2>
      <p>Chimera was abandoned around June. On June 24 the regenerative-engine work was separated under the SABRE name. SABRE planning continued through at least October 22, but no firing was verified and its exact end date is not preserved.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--right">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Program transition</span></div>
      <h2>Chimera subprojects announced</h2>
      <p>The chamber, injector, torch-igniter and thrust-vector-control subprojects were introduced for the 1,500+ lbf Chimera engine. This is the first verified dated Chimera program announcement in the reviewed archive.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    <span class="gare-timeline__dot" aria-hidden="true"></span>
    <article class="gare-timeline__card">
      <time datetime="2024-02">Early 2024</time>
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Design milestone</span></div>
      <h2>New GAR-E defined</h2>
      <p>The approximately 300 lbf replacement engine retained Spender but used a new chamber, nozzle and 12-orifice injector. It was distinct from Fat GAR-E.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--right">
    ...
    <article class="gare-timeline__card">
      ...
      <h2>Cold-flow test day scrubbed</h2>
      <p>The planned test did not progress to a confirmed flow. No media was assigned because no test occurred.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--component">Cold-weather test</span><span class="gare-status gare-status--successful">Completed</span></div>
      <h2>Winter test-tent trial</h2>
      <p>A 40 min tent trial raised the measured temperature from 6 °C to 11 °C while ambient temperature was 3 °C and wind was about 10 km/h. The safety team used the result to define winter test-day go/no-go limits.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    <span class="gare-timeline__dot" aria-hidden="true"></span>
    <article class="gare-timeline__card">
      <time datetime="2022-11-25">November 25, 2022 onward</time>
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Flight-vehicle branch</span></div>
      <h2>Day-Glo and Fat GAR-E</h2>
      <p>Fat GAR-E was proposed as an approximately 4.45–6.67+ kN engine for the Day-Glo flight vehicle. It was a separate development branch, not a rename of the GAR-E engine later fired on Spender. No Fat GAR-E firing or Day-Glo flight was verified.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--right">
    <span class="gare-timeline__dot" aria-hidden="true"></span>
    <article class="gare-timeline__card">
      <time datetime="2022-11-25">November 19–25, 2022</time>
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Design milestone</span></div>
      <h2>Borealis is paused; Spender is named</h2>
      <p>Leadership placed Borealis on hold November 19 to prioritize GAR-E and the feed system. On November 25 the propellant stand and plumbing were named Spender; engine-side computing was Gremlin, data acquisition was LabJack and PLC/power hardware was Simple Jack.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    <span class="gare-timeline__dot" aria-hidden="true"></span>
    <article class="gare-timeline__card">
      <time datetime="2022-11-04">November 4, 2022</time>
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--component">Hydrostatic attempt</span><span class="gare-status gare-status--scrubbed">Postponed</span></div>
      <h2>Borealis chamber proof test scrubbed</h2>
      <p>The October 22 plan called for separate chamber and cooling-jacket hydrostatics, leak checks, dimensional measurements, telemetry and valve actuation. Missing cooling-jacket and plumbing parts delayed the test; on November 4 it was postponed until further notice. No completed Borealis chamber proof test was found.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--right">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Design milestone</span></div>
      <h2>GAR-E is introduced</h2>
      <p>GAR-E retained Borealis's internal combustion geometry but replaced its machined copper chamber with lower-cost, machinable Garolite. The team expected the ablative chamber to cost a few hundred dollars plus the injector.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    <span class="gare-timeline__dot" aria-hidden="true"></span>
    <article class="gare-timeline__card">
      <time datetime="2022-09-30">May 24–September 30, 2022</time>
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--organization">Organization</span></div>
      <h2>RPG becomes MACH</h2>
      <p>The rename process was announced May 24 and a member vote followed July 18. MACH was in active use by August 24, the new logo appeared September 13 and the public RPG-to-MACH transition was announced September 30.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    <span class="gare-timeline__dot" aria-hidden="true"></span>
    <article class="gare-timeline__card">
      <time datetime="2022-08-06">January 31–August 6, 2022</time>
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Launch Canada plan</span><span class="gare-status gare-status--scrubbed">Not completed</span></div>
      <h2>Borealis cold-flow campaign</h2>
      <p>The revised Borealis design targeted 1.76 kN thrust and a 700 psi chamber, with water cooling and water/liquid-CO₂ test fluids. The May progress report still described the propellant stand plumbing as significantly incomplete. RPG attended Launch Canada from August 1–6, but no integrated Borealis flow was recorded.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Test plan</span><span class="gare-status gare-status--scrubbed">Cancelled</span></div>
      <h2>Borealis test cancelled</h2>
      <p>A Combustion Dynamics test scheduled for November 21 was cancelled. The archive does not identify its configuration. The 2020–21 review still listed fabrication, calibration, cold flow and hot fire as future work.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--right">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Design milestone</span></div>
      <h2>Borealis is named</h2>
      <p>The Borealis name appears in project requirements dated September 10. It identified the approximately 1.76 kN ethanol and nitrous oxide research-engine concept.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Launch Canada proposal</span><span class="gare-status gare-status--scrubbed">Not completed</span></div>
      <h2>Inconel engine and cold-flow proposal</h2>
  ...
  <li class="gare-timeline__event gare-timeline__event--right">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Design milestone</span></div>
      <h2>Ethanol and nitrous oxide CDR</h2>
      <p>The proof-of-concept design targeted 1.56 kN thrust, a 500 psi chamber, a 10 s burn, 750 psi run tanks and 0.795 kg/s total propellant flow. It used an 80-channel impinging injector with regenerative and film cooling. The CDR placed component flow, cold-flow and hot-fire testing in future work.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--left">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--program">Design milestone</span></div>
      <h2>First liquid-engine project brief</h2>
      <p>The brief required a liquid engine for a vehicle reaching at least 10,000 ft, an 8 in fuselage limit and remote operation behind a blast shield. It proposed a low-cost small-scale engine before a full-scale version; cold-flow and hot-fire work scheduled for January 2019 was not confirmed as completed.</p>
    </article>
  </li>
  ...
  <li class="gare-timeline__event gare-timeline__event--right">
    ...
    <article class="gare-timeline__card">
      ...
      <div class="gare-timeline__tags"><span class="gare-tag gare-tag--organization">Organization</span></div>
      <h2>Ryerson Propulsion Group begins</h2>
      <p>The March 2019 CDR says RPG was founded in June 2018, and the January 2022 Launch Canada proposal also gives 2018. Later team reports give 2017, but no contemporary 2017 record was found.</p>
    </article>
  </li>
</ol>

<aside class="gare-timeline-note">
  <strong>Record basis</strong>
  <p>Dates and outcomes were cross-checked against design reviews, Launch Canada reports, archived telemetry, test media and contemporary team records. Conflicting or incomplete measurements are labelled instead of being filled in.</p>
</aside>
