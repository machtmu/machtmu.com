...
<div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(min(100%, 24rem), 1fr)); gap:1.25rem; margin:1rem 0 1.5rem 0;">
  <figure style="margin:0;">
    <video controls preload="metadata" playsinline style="display:block; width:100%; aspect-ratio:16/9; object-fit:contain; background:#000; border-radius:8px;">
      <source src="seraphina-hotfire-wide.mp4" type="video/mp4">
  ...
  <figure style="margin:0;">
    <video controls preload="metadata" playsinline style="display:block; width:100%; aspect-ratio:16/9; object-fit:contain; background:#000; border-radius:8px;">
      <source src="seraphina-hotfire-close.mp4" type="video/mp4">
      Your browser does not support embedded video.
    </video>
...
<div style="text-align:center; margin:1rem 0 2rem 0;">
  <a href="seraphina-hotfire-2026-08-06-run-8.csv" class="md-button">Download Raw Test Data (.csv)</a>
</div>
...
<figure style="margin:2rem auto; display:flex; flex-direction:column; align-items:center; justify-content:center; width:100%; text-align:center;">
  <img src="seraphina-hotfire-burn-telemetry.png" alt="Seraphina burn telemetry for August 6th, 2026" style="width:100%; max-width:1000px; height:auto; border-radius:8px; display:block; margin:0 auto; object-fit:contain;">
</figure>

## Team Photo

<figure style="margin:2rem auto; display:flex; flex-direction:column; align-items:center; justify-content:center; width:100%; text-align:center;">
  <img src="seraphina-hotfire-team.jpg" alt="Seraphina team at the August 6th, 2026 hot fire test" style="width:100%; max-width:1000px; height:auto; border-radius:8px; display:block; margin:0 auto; object-fit:cover;">
</figure>
